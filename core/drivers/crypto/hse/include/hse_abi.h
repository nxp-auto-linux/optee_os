 ...
 * @kdf_prf: PRFs used for KDF. Supported options: HSE_KDF_PRF_HMAC,
 *           HSE_KDF_PRF_CMAC.
 * @hmac_hash: hash algorithm used for HMAC
 * @cmac: dummy byte
 * @salt_key_handle: salt key handle; used when the salt is provided as a secret
